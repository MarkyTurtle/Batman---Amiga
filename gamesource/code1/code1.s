...
L000032c0 2f00                     move.l d0,-(a7) [000009ec]
L000032c2 3039 00df f01e           move.w $00dff01e,d0
L000032c8 0800 0002                btst.l #$0002,d0
L000032cc 661e                     bne.b #$1e == $000032ec (T)
L000032ce 0800 0001                btst.l #$0001,d0
L000032d2 660c                     bne.b #$0c == $000032e0 (T)
L000032d4 33fc 0001 00df f09c      move.w #$0001,$00dff09c
L000032dc 201f                     move.l (a7)+ [6000001a],d0
L000032de 4e73                     rte  == $001a6000
L000032e0 33fc 0002 00df f09c      move.w #$0002,$00dff09c
L000032e8 201f                     move.l (a7)+ [6000001a],d0
L000032ea 4e73                     rte  == $001a6000
L000032ec 33fc 0004 00df f09c      move.w #$0004,$00dff09c
L000032f4 201f                     move.l (a7)+ [6000001a],d0
L000032f6 4e73                     rte  == $001a6000
L000032f8 2f00                     move.l d0,-(a7) [000009ec]
L000032fa 1039 00bf ed01           move.b $00bfed01,d0
L00003300 6a10                     bpl.b #$10 == $00003312 (T)
L00003302 6100 00d0                bsr.w #$00d0 == $000033d4
L00003306 33fc 0008 00df f09c      move.w #$0008,$00dff09c
L0000330e 201f                     move.l (a7)+ [6000001a],d0
L00003310 4e73                     rte  == $001a6000
...
L0000368a 33fc 0080 00df f096      move.w #$0080,$00dff096
L00003692 23c8 00df f080           move.l a0,$00dff080
L00003698 33c8 00df f088           move.w a0,$00dff088
L0000369e 33fc 0000 00df f10a      move.w #$0000,$00dff10a
L000036a6 33fc 0000 00df f108      move.w #$0000,$00dff108
L000036ae 33fc 0038 00df f092      move.w #$0038,$00dff092
L000036b6 33fc 00d0 00df f094      move.w #$00d0,$00dff094
L000036be 33fc 3080 00df f08e      move.w #$3080,$00dff08e
L000036c6 33fc 0ac0 00df f090      move.w #$0ac0,$00dff090
L000036ce 33fc 4200 00df f100      move.w #$4200,$00dff100
L000036d6 4279 0000 36ee           clr.w $000036ee [0000]
L000036dc 4a79 0000 36ee           tst.w $000036ee [0000]
L000036e2 67f8                     beq.b #$f8 == $000036dc (F)
L000036e4 33fc 8180 00df f096      move.w #$8180,$00dff096
L000036ec 4e75                     rts  == $6000001a
...
L00003746 41f9 0006 1b9c           lea.l $00061b9c,a0
L0000374c 3e3c 3917                move.w #$3917,d7
L00003750 4298                     clr.l (a0)+ [003c004a]
L00003752 51cf fffc                dbf .w d7,#$fffc == $00003750 (F)
L00003756 41f9 0005 a36c           lea.l $0005a36c,a0
L0000375c 3e3c 1c8b                move.w #$1c8b,d7
L00003760 4298                     clr.l (a0)+ [003c004a]
L00003762 51cf fffc                dbf .w d7,#$fffc == $00003760 (F)
L00003766 4e75                     rts  == $6000001a
...
L0000400c 342e 0008                move.w (a6,$0008) == $00dff008,d2
L00004010 0c42 0007                cmp.w #$0007,d2
L00004014 6618                     bne.b #$18 == $0000402e (T)
L00004016 5b40                     subq.w #$05,d0
L00004018 6100 ff98                bsr.w #$ff98 == $00003fb2
L0000401c 30fc 000d                move.w #$000d,(a0)+ [003c]
L00004020 3601                     move.w d1,d3
L00004022 0443 0011                sub.w #$0011,d3
L00004026 4890 0009                movem.w d0/d3,(a0)
L0000402a 5a40                     addq.w #$05,d0
L0000402c 7408                     moveq #$08,d2
L0000402e 526e 0008                addq.w #$01,(a6,$0008) == $00dff008
L00004032 4bf8 44d4                lea.l $44d4,a5
L00004036 0242 00fe                and.w #$00fe,d2
L0000403a dac2                     adda.w d2,a5
L0000403c d442                     add.w d2,d2
L0000403e dac2                     adda.w d2,a5
L00004040 6000 053a                bra.w #$053a == $0000457c (T)
L00004044 4bf8 44ec                lea.l $44ec,a5
L00004048 6100 0532                bsr.w #$0532 == $0000457c
L0000404c 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004050 660a                     bne.b #$0a == $0000405c (T)
L00004052 3d7c 0020 0008           move.w #$0020,(a6,$0008) == $00dff008
L00004058 3cbc 0002                move.w #$0002,(a6)
L0000405c 4e75                     rts  == $6000001a
L0000405e 0c40 ffc0                cmp.w #$ffc0,d0
L00004062 6b4c                     bmi.b #$4c == $000040b0 (F)
L00004064 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004068 6a18                     bpl.b #$18 == $00004082 (T)
L0000406a 3400                     move.w d0,d2
L0000406c 9478 67c2                sub.w $67c2 [0050],d2
L00004070 0c42 0030                cmp.w #$0030,d2
L00004074 640c                     bcc.b #$0c == $00004082 (T)
L00004076 426e 0008                clr.w (a6,$0008) == $00dff008
L0000407a 3cbc 0005                move.w #$0005,(a6)
L0000407e 6000 029e                bra.w #$029e == $0000431e (T)
L00004082 7407                     moveq #$07,d2
L00004084 c444                     and.w d4,d2
L00004086 6600 0290                bne.w #$0290 == $00004318 (T)
L0000408a 0440 000c                sub.w #$000c,d0
L0000408e 6100 1510                bsr.w #$1510 == $000055a0
L00004092 0640 000c                add.w #$000c,d0
L00004096 0c02 0079                cmp.b #$79,d2
L0000409a 6400 027c                bcc.w #$027c == $00004318 (T)
L0000409e 4a6e 0008                tst.w (a6,$0008) == $00dff008
L000040a2 6a0c                     bpl.b #$0c == $000040b0 (T)
L000040a4 3400                     move.w d0,d2
L000040a6 9478 67c2                sub.w $67c2 [0050],d2
L000040aa 0c42 0040                cmp.w #$0040,d2
L000040ae 65c6                     bcs.b #$c6 == $00004076 (F)
L000040b0 3cbc 0002                move.w #$0002,(a6)
L000040b4 6000 0268                bra.w #$0268 == $0000431e (T)
L000040b8 342e 0008                move.w (a6,$0008) == $00dff008,d2
L000040bc 0c42 0007                cmp.w #$0007,d2
L000040c0 6618                     bne.b #$18 == $000040da (T)
L000040c2 5a40                     addq.w #$05,d0
L000040c4 6100 feec                bsr.w #$feec == $00003fb2
L000040c8 30fc 000c                move.w #$000c,(a0)+ [003c]
L000040cc 3601                     move.w d1,d3
L000040ce 0443 0011                sub.w #$0011,d3
L000040d2 4890 0009                movem.w d0/d3,(a0)
L000040d6 5b40                     subq.w #$05,d0
L000040d8 7408                     moveq #$08,d2
L000040da 526e 0008                addq.w #$01,(a6,$0008) == $00dff008
L000040de 4bf8 44f2                lea.l $44f2,a5
L000040e2 0242 00fe                and.w #$00fe,d2
L000040e6 dac2                     adda.w d2,a5
L000040e8 d442                     add.w d2,d2
L000040ea dac2                     adda.w d2,a5
L000040ec 6000 048e                bra.w #$048e == $0000457c (T)
L000040f0 4bf8 450a                lea.l $450a,a5
L000040f4 6100 0486                bsr.w #$0486 == $0000457c
L000040f8 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L000040fc 660a                     bne.b #$0a == $00004108 (T)
L000040fe 3d7c 0020 0008           move.w #$0020,(a6,$0008) == $00dff008
L00004104 3cbc 0003                move.w #$0003,(a6)
L00004108 4e75                     rts  == $6000001a
L0000410a 0c40 00e0                cmp.w #$00e0,d0
L0000410e 6a48                     bpl.b #$48 == $00004158 (T)
L00004110 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004114 6a18                     bpl.b #$18 == $0000412e (T)
L00004116 3438 67c2                move.w $67c2 [0050],d2
L0000411a 9440                     sub.w d0,d2
L0000411c 0c42 0030                cmp.w #$0030,d2
L00004120 640c                     bcc.b #$0c == $0000412e (T)
L00004122 426e 0008                clr.w (a6,$0008) == $00dff008
L00004126 3cbc 0004                move.w #$0004,(a6)
L0000412a 6000 011c                bra.w #$011c == $00004248 (T)
L0000412e 7407                     moveq #$07,d2
L00004130 c444                     and.w d4,d2
L00004132 6600 010e                bne.w #$010e == $00004242 (T)
L00004136 5040                     addq.w #$08,d0
L00004138 6100 1466                bsr.w #$1466 == $000055a0
L0000413c 5140                     subq.w #$08,d0
L0000413e 0c02 0079                cmp.b #$79,d2
L00004142 6400 00fe                bcc.w #$00fe == $00004242 (T)
L00004146 4a6e 0008                tst.w (a6,$0008) == $00dff008
L0000414a 6a0c                     bpl.b #$0c == $00004158 (T)
L0000414c 3438 67c2                move.w $67c2 [0050],d2
L00004150 9440                     sub.w d0,d2
L00004152 0c42 0040                cmp.w #$0040,d2
L00004156 65ca                     bcs.b #$ca == $00004122 (F)
L00004158 3cbc 0003                move.w #$0003,(a6)
L0000415c 6000 00ea                bra.w #$00ea == $00004248 (T)
L00004160 3a38 67c4                move.w $67c4 [0048],d5
L00004164 9a41                     sub.w d1,d5
L00004166 0645 0010                add.w #$0010,d5
L0000416a 0c45 0020                cmp.w #$0020,d5
L0000416e 6530                     bcs.b #$30 == $000041a0 (F)
L00004170 6a12                     bpl.b #$12 == $00004184 (T)
L00004172 3439 0000 8002           move.w $00008002 [00c0],d2
L00004178 d442                     add.w d2,d2
L0000417a d442                     add.w d2,d2
L0000417c 9642                     sub.w d2,d3
L0000417e 4242                     clr.w d2
L00004180 1430 3000                move.b (a0,d3.W,$00) == $00000d13 [d6],d2
L00004184 0c02 0085                cmp.b #$85,d2
L00004188 6516                     bcs.b #$16 == $000041a0 (F)
L0000418a 3d7c 0002 0008           move.w #$0002,(a6,$0008) == $00dff008
L00004190 3d7c 000d 000c           move.w #$000d,(a6,$000c) == $00dff00c
L00004196 5145                     subq.w #$08,d5
L00004198 6a06                     bpl.b #$06 == $000041a0 (T)
L0000419a 3d7c 000c 000c           move.w #$000c,(a6,$000c) == $00dff00c
L000041a0 4e75                     rts  == $6000001a
L000041a2 3404                     move.w d4,d2
L000041a4 5842                     addq.w #$04,d2
L000041a6 0242 0007                and.w #$0007,d2
L000041aa 6600 0096                bne.w #$0096 == $00004242 (T)
L000041ae 0c40 0140                cmp.w #$0140,d0
L000041b2 6a0e                     bpl.b #$0e == $000041c2 (T)
L000041b4 5e40                     addq.w #$07,d0
L000041b6 6100 13e8                bsr.w #$13e8 == $000055a0
L000041ba 5f40                     subq.w #$07,d0
L000041bc 0c02 0079                cmp.b #$79,d2
L000041c0 640c                     bcc.b #$0c == $000041ce (T)
L000041c2 3cbc 000f                move.w #$000f,(a6)
L000041c6 426e 0008                clr.w (a6,$0008) == $00dff008
L000041ca 6000 0076                bra.w #$0076 == $00004242 (T)
L000041ce 6100 ff90                bsr.w #$ff90 == $00004160
L000041d2 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L000041d6 6700 0170                beq.w #$0170 == $00004348 (F)
L000041da 6a66                     bpl.b #$66 == $00004242 (T)
L000041dc 3438 67c2                move.w $67c2 [0050],d2
L000041e0 9440                     sub.w d0,d2
L000041e2 6b5e                     bmi.b #$5e == $00004242 (F)
L000041e4 0c45 0020                cmp.w #$0020,d5
L000041e8 6a3a                     bpl.b #$3a == $00004224 (T)
L000041ea 6416                     bcc.b #$16 == $00004202 (T)
L000041ec 0c42 0038                cmp.w #$0038,d2
L000041f0 6450                     bcc.b #$50 == $00004242 (T)
L000041f2 3d7c 0010 000c           move.w #$0010,(a6,$000c) == $00dff00c
L000041f8 2d7c 0001 0000 0008      move.l #$00010000,(a6,$0008) == $00dff008
L00004200 6040                     bra.b #$40 == $00004242 (T)
L00004202 0445 0010                sub.w #$0010,d5
L00004206 d445                     add.w d5,d2
L00004208 6f38                     ble.b #$38 == $00004242 (F)
L0000420a 5942                     subq.w #$04,d2
L0000420c e64a                     lsr.w #$03,d2
L0000420e 5242                     addq.w #$01,d2
L00004210 0c42 0008                cmp.w #$0008,d2
L00004214 642c                     bcc.b #$2c == $00004242 (T)
L00004216 3d42 0008                move.w d2,(a6,$0008) == $00dff008
L0000421a 2d7c 0005 0010 000a      move.l #$00050010,(a6,$000a) == $00dff00a
L00004222 601e                     bra.b #$1e == $00004242 (T)
L00004224 5145                     subq.w #$08,d5
L00004226 9445                     sub.w d5,d2
L00004228 6318                     bls.b #$18 == $00004242 (F)
L0000422a 5942                     subq.w #$04,d2
L0000422c e64a                     lsr.w #$03,d2
L0000422e 5242                     addq.w #$01,d2
L00004230 0c42 0008                cmp.w #$0008,d2
L00004234 640c                     bcc.b #$0c == $00004242 (T)
L00004236 3d42 0008                move.w d2,(a6,$0008) == $00dff008
L0000423a 2d7c 0007 0010 000a      move.l #$00070010,(a6,$000a) == $00dff00a
L00004242 5244                     addq.w #$01,d4
L00004244 3d44 0002                move.w d4,(a6,$0002) == $00dff002
L00004248 0244 000e                and.w #$000e,d4
L0000424c e24c                     lsr.w #$01,d4
L0000424e 3f04                     move.w d4,-(a7) [09ec]
L00004250 5044                     addq.w #$08,d4
L00004252 3404                     move.w d4,d2
L00004254 6100 0366                bsr.w #$0366 == $000045bc
L00004258 341f                     move.w (a7)+ [6000],d2
L0000425a e24a                     lsr.w #$01,d2
L0000425c 6602                     bne.b #$02 == $00004260 (T)
L0000425e 5442                     addq.w #$02,d2
L00004260 5842                     addq.w #$04,d2
L00004262 6100 0358                bsr.w #$0358 == $000045bc
L00004266 7404                     moveq #$04,d2
L00004268 6000 0320                bra.w #$0320 == $0000458a (T)
L0000426c 3404                     move.w d4,d2
L0000426e 5842                     addq.w #$04,d2
L00004270 0242 0007                and.w #$0007,d2
L00004274 6600 00a2                bne.w #$00a2 == $00004318 (T)
L00004278 0c40 ff60                cmp.w #$ff60,d0
L0000427c 6b1a                     bmi.b #$1a == $00004298 (F)
L0000427e 5f40                     subq.w #$07,d0
L00004280 6100 131e                bsr.w #$131e == $000055a0
L00004284 5e40                     addq.w #$07,d0
L00004286 0c02 0079                cmp.b #$79,d2
L0000428a 6418                     bcc.b #$18 == $000042a4 (T)
L0000428c 342e 0006                move.w (a6,$0006) == $00dff006,d2
L00004290 0c42 0085                cmp.w #$0085,d2
L00004294 6700 0174                beq.w #$0174 == $0000440a (F)
L00004298 3cbc 000e                move.w #$000e,(a6)
L0000429c 426e 0008                clr.w (a6,$0008) == $00dff008
L000042a0 6000 0076                bra.w #$0076 == $00004318 (T)
L000042a4 6100 feba                bsr.w #$feba == $00004160
L000042a8 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L000042ac 6700 009a                beq.w #$009a == $00004348 (F)
L000042b0 6a66                     bpl.b #$66 == $00004318 (T)
L000042b2 3400                     move.w d0,d2
L000042b4 9478 67c2                sub.w $67c2 [0050],d2
L000042b8 6b5e                     bmi.b #$5e == $00004318 (F)
L000042ba 0c45 0020                cmp.w #$0020,d5
L000042be 6a3a                     bpl.b #$3a == $000042fa (T)
L000042c0 6416                     bcc.b #$16 == $000042d8 (T)
L000042c2 0c42 0038                cmp.w #$0038,d2
L000042c6 6450                     bcc.b #$50 == $00004318 (T)
L000042c8 3d7c 0010 000c           move.w #$0010,(a6,$000c) == $00dff00c
L000042ce 2d7c 0001 0001 0008      move.l #$00010001,(a6,$0008) == $00dff008
L000042d6 6040                     bra.b #$40 == $00004318 (T)
L000042d8 0445 0010                sub.w #$0010,d5
L000042dc d445                     add.w d5,d2
L000042de 6f38                     ble.b #$38 == $00004318 (F)
L000042e0 5942                     subq.w #$04,d2
L000042e2 e64a                     lsr.w #$03,d2
L000042e4 5242                     addq.w #$01,d2
L000042e6 0c42 0008                cmp.w #$0008,d2
L000042ea 642c                     bcc.b #$2c == $00004318 (T)
L000042ec 3d42 0008                move.w d2,(a6,$0008) == $00dff008
L000042f0 2d7c 0004 0010 000a      move.l #$00040010,(a6,$000a) == $00dff00a
L000042f8 601e                     bra.b #$1e == $00004318 (T)
L000042fa 5145                     subq.w #$08,d5
L000042fc 9445                     sub.w d5,d2
L000042fe 6318                     bls.b #$18 == $00004318 (F)
L00004300 5942                     subq.w #$04,d2
L00004302 e64a                     lsr.w #$03,d2
L00004304 5242                     addq.w #$01,d2
L00004306 0c42 0008                cmp.w #$0008,d2
L0000430a 640c                     bcc.b #$0c == $00004318 (T)
L0000430c 3d42 0008                move.w d2,(a6,$0008) == $00dff008
L00004310 2d7c 0006 0010 000a      move.l #$00060010,(a6,$000a) == $00dff00a
L00004318 5344                     subq.w #$01,d4
L0000431a 3d44 0002                move.w d4,(a6,$0002) == $00dff002
L0000431e 0244 000e                and.w #$000e,d4
L00004322 e24c                     lsr.w #$01,d4
L00004324 0a44 e007                eor.w #$e007,d4
L00004328 3f04                     move.w d4,-(a7) [09ec]
L0000432a 5044                     addq.w #$08,d4
L0000432c 3404                     move.w d4,d2
L0000432e 6100 028c                bsr.w #$028c == $000045bc
L00004332 341f                     move.w (a7)+ [6000],d2
L00004334 e20a                     lsr.b #$01,d2
L00004336 6602                     bne.b #$02 == $0000433a (T)
L00004338 5442                     addq.w #$02,d2
L0000433a 5842                     addq.w #$04,d2
L0000433c 6100 027e                bsr.w #$027e == $000045bc
L00004340 343c e004                move.w #$e004,d2
L00004344 6000 0244                bra.w #$0244 == $0000458a (T)
L00004348 3c2e 000c                move.w (a6,$000c) == $00dff00c,d6
L0000434c 3c86                     move.w d6,(a6)
L0000434e 0c46 0010                cmp.w #$0010,d6
L00004352 6620                     bne.b #$20 == $00004374 (T)
L00004354 3d7c 0002 0008           move.w #$0002,(a6,$0008) == $00dff008
L0000435a 342e 000a                move.w (a6,$000a) == $00dff00a,d2
L0000435e 0c42 0002                cmp.w #$0002,d2
L00004362 6410                     bcc.b #$10 == $00004374 (T)
L00004364 342e 0012                move.w (a6,$0012) == $00dff012,d2
L00004368 5842                     addq.w #$04,d2
L0000436a 9478 62f0                sub.w $62f0 [0000],d2
L0000436e 6a04                     bpl.b #$04 == $00004374 (T)
L00004370 546e 000a                addq.w #$02,(a6,$000a) == $00dff00a
L00004374 41f8 5a9a                lea.l $5a9a,a0
L00004378 dc46                     add.w d6,d6
L0000437a d0c6                     adda.w d6,a0
L0000437c 3050                     movea.w (a0) [003c],a0
L0000437e 4ed0                     jmp (a0)
L00004380 382e 0004                move.w (a6,$0004) == $00dff004,d4
L00004384 0838 0000 632d           btst.b #$0000,$632d [00]
L0000438a 6642                     bne.b #$42 == $000043ce (T)
L0000438c 5244                     addq.w #$01,d4
L0000438e 3d44 0004                move.w d4,(a6,$0004) == $00dff004
L00004392 5241                     addq.w #$01,d1
L00004394 0244 0007                and.w #$0007,d4
L00004398 6634                     bne.b #$34 == $000043ce (T)
L0000439a 6100 1204                bsr.w #$1204 == $000055a0
L0000439e 6026                     bra.b #$26 == $000043c6 (T)
L000043a0 382e 0004                move.w (a6,$0004) == $00dff004,d4
L000043a4 0838 0000 632d           btst.b #$0000,$632d [00]
L000043aa 6622                     bne.b #$22 == $000043ce (T)
L000043ac 5344                     subq.w #$01,d4
L000043ae 3d44 0004                move.w d4,(a6,$0004) == $00dff004
L000043b2 5341                     subq.w #$01,d1
L000043b4 0244 0007                and.w #$0007,d4
L000043b8 6614                     bne.b #$14 == $000043ce (T)
L000043ba 0441 0018                sub.w #$0018,d1
L000043be 6100 11e0                bsr.w #$11e0 == $000055a0
L000043c2 0641 0018                add.w #$0018,d1
L000043c6 0c02 0085                cmp.b #$85,d2
L000043ca 6402                     bcc.b #$02 == $000043ce (T)
L000043cc 612e                     bsr.b #$2e == $000043fc
L000043ce 4644                     not.w d4
L000043d0 0244 0007                and.w #$0007,d4
L000043d4 5340                     subq.w #$01,d0
L000043d6 3404                     move.w d4,d2
L000043d8 0882 0002                bclr.l #$0002,d2
L000043dc 6706                     beq.b #$06 == $000043e4 (F)
L000043de 0042 e000                or.w #$e000,d2
L000043e2 5240                     addq.w #$01,d0
L000043e4 0642 001b                add.w #$001b,d2
L000043e8 3f02                     move.w d2,-(a7) [09ec]
L000043ea 6100 01d0                bsr.w #$01d0 == $000045bc
L000043ee 341f                     move.w (a7)+ [6000],d2
L000043f0 0242 e000                and.w #$e000,d2
L000043f4 0642 001a                add.w #$001a,d2
L000043f8 6000 0190                bra.w #$0190 == $0000458a (T)
L000043fc 7407                     moveq #$07,d2
L000043fe 764c                     moveq #$4c,d3
L00004400 9640                     sub.w d0,d3
L00004402 d643                     add.w d3,d3
L00004404 d542                     addx.w d2,d2
L00004406 3c82                     move.w d2,(a6)
L00004408 4e75                     rts  == $6000001a
L0000440a 3d7c ffff 0008           move.w #$ffff,(a6,$0008) == $00dff008
L00004410 7406                     moveq #$06,d2
L00004412 b278 62f0                cmp.w $62f0 [0000],d1
L00004416 6b10                     bmi.b #$10 == $00004428 (F)
L00004418 7401                     moveq #$01,d2
L0000441a 362e 0012                move.w (a6,$0012) == $00dff012,d3
L0000441e 5843                     addq.w #$04,d3
L00004420 b678 62f0                cmp.w $62f0 [0000],d3
L00004424 6a02                     bpl.b #$02 == $00004428 (T)
L00004426 5442                     addq.w #$02,d2
L00004428 3d42 000a                move.w d2,(a6,$000a) == $00dff00a
L0000442c 3cbc 0010                move.w #$0010,(a6)
L00004430 6100 013e                bsr.w #$013e == $00004570
L00004434 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004438 6a08                     bpl.b #$08 == $00004442 (T)
L0000443a 5256                     addq.w #$01,(a6)
L0000443c 3d7c 0003 0008           move.w #$0003,(a6,$0008) == $00dff008
L00004442 4e75                     rts  == $6000001a
L00004444 6100 012a                bsr.w #$012a == $00004570
L00004448 0839 0000 0000 632d      btst.b #$0000,$0000632d [00]
L00004450 66f0                     bne.b #$f0 == $00004442 (T)
L00004452 6100 01ea                bsr.w #$01ea == $0000463e
L00004456 925d                     sub.w (a5)+,d1
L00004458 d278 6310                add.w $6310 [0000],d1
L0000445c d05d                     add.w (a5)+,d0
L0000445e d078 630e                add.w $630e [0000],d0
L00004462 30d5                     move.w (a5),(a0)+ [003c]
L00004464 4890 0003                movem.w d0-d1,(a0)
L00004468 740c                     moveq #$0c,d2
L0000446a 6100 004a                bsr.w #$004a == $000044b6
L0000446e 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004472 66ce                     bne.b #$ce == $00004442 (T)
L00004474 3d7c 0006 0008           move.w #$0006,(a6,$0008) == $00dff008
L0000447a 5256                     addq.w #$01,(a6)
L0000447c 4e75                     rts  == $6000001a
L0000447e 6100 00f0                bsr.w #$00f0 == $00004570
L00004482 536e 0008                subq.w #$01,(a6,$0008) == $00dff008
L00004486 66ba                     bne.b #$ba == $00004442 (T)
L00004488 3d7c 0004 0008           move.w #$0004,(a6,$0008) == $00dff008
L0000448e 342e 000a                move.w (a6,$000a) == $00dff00a,d2
L00004492 362e 0006                move.w (a6,$0006) == $00dff006,d3
L00004496 0c43 0085                cmp.w #$0085,d3
L0000449a 6604                     bne.b #$04 == $000044a0 (T)
L0000449c 343c 0001                move.w #$0001,d2
L000044a0 4642                     not.w d2
L000044a2 0242 0001                and.w #$0001,d2
L000044a6 0642 000e                add.w #$000e,d2
L000044aa 3c82                     move.w d2,(a6)
L000044ac 3d42 000c                move.w d2,(a6,$000c) == $00dff00c
L000044b0 382e 0002                move.w (a6,$0002) == $00dff002,d4
L000044b4 4e75                     rts  == $6000001a
L000044b6 0c40 00a0                cmp.w #$00a0,d0
L000044ba 64f8                     bcc.b #$f8 == $000044b4 (T)
L000044bc 0c41 0059                cmp.w #$0059,d1
L000044c0 64f2                     bcc.b #$f2 == $000044b4 (T)
L000044c2 48a7 c000                movem.w d0-d1,-(a7)
L000044c6 3002                     move.w d2,d0
L000044c8 4eb9 0004 8014           jsr $00048014
L000044ce 4c9f 0003                movem.w (a7)+,d0-d1
L000044d2 4e75                     rts  == $6000001a
